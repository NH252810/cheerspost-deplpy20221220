...
all_data2 = all_data[all_data["price"] <= price_slider]
asahi_data2 = asahi_data[asahi_data["price"] <= price_slider]
kirin_data2 = kirin_data[kirin_data["price"] <= price_slider]
ebis_data2 = ebis_data[ebis_data["price"] <= price_slider]
premium_data2 = premium_data[premium_data["price"] <= price_slider]
mlts_data2 = mlts_data[mlts_data["price"] <= price_slider]
hoeg_data2 = hoeg_data[hoeg_data["price"] <= price_slider]
corona_data2 = corona_data[corona_data["price"] <= price_slider]
...
for i, row in asahi_data2.iterrows():
    folium.Marker(
        location=[row['lat'], row['lng']],
        popup = row['name'] + "<br>【ジャンル】"+row['genre'] + "</br>" + row['url'],
...
for i, row in kirin_data2.iterrows():
    folium.Marker(
        location=[row['lat'], row['lng']],
        popup = row['name'] + "<br>【ジャンル】"+row['genre'] + "</br>" + row['url'],
...
for i, row in ebis_data2.iterrows():
    folium.Marker(
        location=[row['lat'], row['lng']],
        popup = row['name'] + "<br>【ジャンル】"+row['genre'] + "</br>" + row['url'],
...
for i, row in premium_data2.iterrows():
    folium.Marker(
        location=[row['lat'], row['lng']],
        popup = row['name'] + "<br>【ジャンル】"+row['genre'] + "</br>" + row['url'],
...
for i, row in mlts_data2.iterrows():
    folium.Marker(
        location=[row['lat'], row['lng']],
        popup = row['name'] + "<br>【ジャンル】"+row['genre'] + "</br>" + row['url'],
...
for i, row in hoeg_data2.iterrows():
    folium.Marker(
        location=[row['lat'], row['lng']],
        popup = row['name'] + "<br>【ジャンル】"+row['genre'] + "</br>" + row['url'],
...
for i, row in corona_data2.iterrows():
    folium.Marker(
        location=[row['lat'], row['lng']],
        popup = row['name'] + "<br>【ジャンル】"+row['genre'] + "</br>" + row['url'],
...
for i, row in guinness_data2.iterrows():
    folium.Marker(
        location=[row['lat'], row['lng']],
        popup = row['name'] + "<br>【ジャンル】"+row['genre'] + "</br>" + row['url'],
